...
<!-- Mirrored from html.hixstudio.net/poorex-prev/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 06:05:37 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    <main>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-breadcrumb__content z-index-5">
                            ...
                            <span>Ragister Page</span>
                            </div>
                            <h3 class="tp-breadcrumb__title">Register Page</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- login area start -->
        <section class="tp-login-area pt-120 pb-120 p-relative z-index-1 fix">
            <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                        <h3 class="tp-login-title">Sign Up Poorex.</h3>                           
                        </div>
                        ...
                        <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                            ...
                            <div class="tp-login-option-item">
                                <a href="#">
                                    <img class="apple" src="assets/img/login/apple.svg" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="tp-login-input-wrapper">
                            ...
                            <div class="tp-login-input-box">
                                <div class="tp-login-input">
                                    <input id="tp_password" type="password" placeholder="password">
                                </div>
                        ...
                        <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                            <div class="tp-login-remeber">
                                ...
                                <label for="remeber">I accept the terms of the service and privacy policy</label>
                            </div>
                        ...
                        <div class="tp-login-bottom">
                            <a href="profile.html" class="tp-login-btn w-100">Sign Up</a>
                        </div>
                        </div>
                    </div>
                </div>
